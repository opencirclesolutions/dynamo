...
import ${package}.application.service.MyEntityService;
 ...
 */
@SpringView(name = Views.ENTITY_VIEW)
@UIScope
@SuppressWarnings("serial")
public class MyEntityView extends BaseView {
    ...
    @Inject
    private MyEntityService movieService;
    ...
    public void enter(ViewChangeEvent event) {
        ...
        // of data.
        SimpleSearchLayout<Integer, MyEntity> movieLayout = new SimpleSearchLayout<Integer, MyEntity>(
                movieService, getModelFactory().getModel(MyEntity.class), QueryType.ID_BASED, fo,
