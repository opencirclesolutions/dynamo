...
:keywords: Dynamo, {asciidoc-organization-name}, Web Application Accelerator Framework, Training
...
<d-generic-search-layout entityName="Organization"
  detailNavigationPath="organization"></d-generic-search-layout>
--

* As you can see, we define an `<d-generic-search-layout>` component
...
.Search buttons.
image::media/training/image3.png[image,width=458,height=70]
...
image::media/training/image4.png[image,width=424,height=328]
...
.Lookup field.
image::media/training/image5.png[image,width=429,height=68]
...
image::media/training/image6.png[image,width=560,height=361]
...
.An edit form.
image::media/training/image7.png[image,width=560,height=570]
...
image::media/training/image8.png[image,width=559,height=26]
...
.Numeric input field.
image::media/training/image9.png[image,width=560,height=53]
...
image::media/training/image10.png[image,width=560,height=79]
...
the `formWidthClass` property on the `d-generic-form`. This property
...
image::media/training/image11.png[image,width=560,height=279]
...
.Main activity field.
image::media/training/image12.png[image,width=462,height=61]
...
[source,html]
--
<d-generic-split-layout entityName="Person">
</d-generic-split-layout>
--

Which will produce a screen that looks as follows:

.Split layout screen.
image::media/training/image13.png[image,width=560,height=247]
...
[source,html]
--
<d-generic-split-layout entityName="Gift"></d-generic-split-layout>
--
...
image::media/training/image14.png[image,width=560,height=191]
...
[source,html]
--
<d-generic-edit-table-layout entityName="Delivery">
...
In the `d-generic-split-layout` we created before, we add a template named
...
image::media/training/image15.png[image,width=560,height=24]
...
image::media/training/image16.png[image,width=559,height=107]
...
image::media/training/image17.png[image,width=503,height=407]
...
image::media/training/image18.png[image,width=560,height=81]
