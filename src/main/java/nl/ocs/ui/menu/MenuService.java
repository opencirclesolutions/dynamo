...
import nl.ocs.ui.auth.PermissionChecker;
...
public class MenuService {
	 ...
	 * 
	 * @param parent
	 *            the parent component (either a menu bar or menu item) to add
	 *            the menu to
	 * @param key
	 *            the message key
	 * @param navigator
	 ...
	 * 
	 * @param rootName
	 *            the root name (prefix) of the messages that are used to
	 *            populate the menu
	 * @param navigator
	 *            Vaadin navigator
	 * @return
	...
	/**
	 * Recursively process all menu items and hides the items that have no
	 * visible children
	 * 
	 * @param bar
	 */
