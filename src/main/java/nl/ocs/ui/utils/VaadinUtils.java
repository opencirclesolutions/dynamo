...
import nl.ocs.ui.converter.BigDecimalConverter;
...
public final class VaadinUtils {
	...
	/**
	 * Returns the currency symbol to be used - by default this is looked up
	 * from the session, with a fallback to the system property
	...
	/**
	 * Returns the parent component of the specified component that has a
	 * certain class
	 * 
	 * @param c
	 * @param clazz
	...
	/**
	 * Returns the user's time zone (based on the offset). The result of this
	 * method can be passed to a date converter or simple date format to make
	 * sure the date is properly formatted
	 * 
	 * @return
	 */
