...
import nl.ocs.exception.OCSNonUniqueException;
import nl.ocs.exception.OCSSecurityException;
import nl.ocs.exception.OCSValidationException;
import nl.ocs.service.BaseService;
import nl.ocs.ui.component.DefaultEmbedded;
...
import nl.ocs.ui.composite.type.AttributeGroupMode;
...
public class ModelBasedEditForm<ID extends Serializable, T extends AbstractEntity<ID>> extends
	...
	private class UploadReceiver implements SucceededListener, Receiver {
		...
		public UploadReceiver(Embedded target, String fieldName, String... supportedExtensions) {
			this.target = target;
