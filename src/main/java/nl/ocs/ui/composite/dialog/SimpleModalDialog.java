package nl.ocs.ui.composite.dialog;
...
public abstract class SimpleModalDialog extends BaseModalDialog {
	...
	protected void doBuildButtonBar(HorizontalLayout buttonBar) {
		okButton = new Button(nl.ocs.ui.ServiceLocator.getMessageService().getMessage("ocs.ok"));
		...
		cancelButton = new Button(nl.ocs.ui.ServiceLocator.getMessageService().getMessage(
				"ocs.cancel"));
