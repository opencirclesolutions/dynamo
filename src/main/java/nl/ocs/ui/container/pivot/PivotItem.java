package nl.ocs.ui.container.pivot;
...
public class PivotItem implements Item {
	 ...
	 * "columnValue_columnPropertyId" then a property in the column designated
	 * by the columnValue is assumed. Otherwise the property is assumed to be
	 * equal over all columns and will be taken from the first item.
	 * 
