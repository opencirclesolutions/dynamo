...
change the value of the *searchForExactValue* setting to true_;_ if
...
This setting defaults to false_._
...
represents an image. By default, this setting has the value false_._
...
false_._ If set to true, then the value of the property will be
...
The default value is false_._ If set to *true,* then a validator will
