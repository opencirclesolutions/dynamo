...
public class EntityModelUtilsTest extends BaseMockitoTest {
    ...
    public void testGetDisplayPropertyValue3() {
        ...
        String value = EntityModelUtils.getDisplayPropertyValue(List.of(entity, entity2, entity3), model, 2, messageService, Locale.ENGLISH);
        assertEquals("test name, test name 2, dynamoframework.and.others", value);
    }
