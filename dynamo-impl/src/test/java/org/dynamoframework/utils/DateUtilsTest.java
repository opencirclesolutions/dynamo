...
public class DateUtilsTest {
	...
	public void testCreateInstant() {
		assertNull(DateUtils.createInstant(null, "dd-MM-yyyy HH:mm:ss"));

		Instant ld = DateUtils.createInstant("01-01-2015 12:13:14", "dd-MM-yyyy HH:mm:ss");
		assertEquals("2015-01-01T12:13:14Z", ld.toString());
	}
	...
	public void testFormatInstant() {
		Instant instant = LocalDateTime.of(2013, 12, 1, 11, 14, 15)
			.toInstant(ZoneOffset.UTC);

		assertNull(DateUtils.formatInstant(null, "dd-MM-yyyy"));
		assertNull(DateUtils.formatInstant(instant, null));

		assertEquals("01-12-2013 11:14:15", DateUtils.formatInstant(instant, "dd-MM-yyyy HH:mm:ss"));
		assertEquals("01/12/2013 11:14:15", DateUtils.formatInstant(instant, "dd/MM/yyyy HH:mm:ss"));
	}
	...
	public void testFormatJava8Date() {
		...
		assertEquals("31-03-2014 05:06:07", DateUtils.formatJava8Date(LocalDateTime.class,
			DateUtils.createLocalDateTime("31032014 050607"), "dd-MM-yyyy HH:mm:ss"));

		assertEquals("05:06:07", DateUtils.formatJava8Date(LocalTime.class, DateUtils.createLocalTime("050607"),
			"HH:mm:ss"));
	}
