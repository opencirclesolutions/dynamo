...
public class FilterTest {
    ...
    public void testFilterAnd() {
        ...
        Assert.assertFalse(conjunction.equals(new And(new Like("name", "%er%"), new Compare.Equal("age", 24L))));
    ...
    public void testFilterOr() {
        ...
        Assert.assertFalse(disjunction.equals(new Or(new Like("name", "%er%"), new Compare.Equal("age", 24L))));
    }
