...
public class JpaQueryBuilderTest extends BackendIntegrationTest {
    ...
    public void testCreateCountQuery_Between() {
        TypedQuery<Long> tQuery = JpaQueryBuilder.createCountQuery(entityManager, TestEntity.class, new com.ocs.dynamo.filter.Between("age", 20L, 30L), false);
        long count = tQuery.getSingleResult();
        assertEquals(1, count);
    }
    ...
    public void testCreateFetchQuery() {
        ...
        TypedQuery<TestEntity> tQuery = createFetchQuery(entityManager, TestEntity.class, List.of(e1.getId()), null, null);
    ...
    public void testCreateFetchQueryAdditionalFilter() {
        ...
        TypedQuery<TestEntity> tQuery = createFetchQuery(entityManager, TestEntity.class, List.of(e1.getId()), new Compare.Equal("name", "Bob"), null);
        List<TestEntity> entity = tQuery.getResultList();
