...
//			AndPredicate<T> junction = (AndPredicate<T>) predicate;
...
//				return like;
//			}
//		} else if (filter instanceof SimpleStringPredicate && (types == null || types.contains(filter.getClass()))) {
//			SimpleStringPredicate<T> ssf = (SimpleStringPredicate) filter;
