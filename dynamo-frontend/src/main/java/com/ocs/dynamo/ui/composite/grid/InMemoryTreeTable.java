...
//
///**
// * A custom tree table for displaying a hierarchical data collection. This table
...
//					tf.addFocusListener(event -> clickedColumn = propertyId.toString());
//
...
//				messageService.getMessage("ocs.copy.previous.column", VaadinUtils.getLocale()));
//		final Action clearColumnAction = new Action(
//				messageService.getMessage("ocs.clear.column", VaadinUtils.getLocale()));
//		final Action fillColumnAction = new Action(
//				messageService.getMessage("ocs.fill.column", VaadinUtils.getLocale()));
//
...
//						InMemoryTreeTable.this.handleChange(PREFIX_CHILDROW + i, targetColumnId,
//								value == null ? null : convertToString(toBigDecimal((Number) value), targetColumnId));
//					}
//					i++;
//				}
//			}
...
//
//	/**
//	 * Returns an array of Strings containing the propertyId IDs of the columns
//	 * to update after a change to a certain column
//	 * 
//	 * @param propertyId
...
//
//	/**
//	 * Returns the property IDs of the columns for which a sum (on the parent
...
//
//	/**
//	 * Stores the column on which the user clicked for the last time. This is
//	 * used to determine the action to undertake from the right-click menu
//	 * 
//	 * @param clickedColumn
//	 */
