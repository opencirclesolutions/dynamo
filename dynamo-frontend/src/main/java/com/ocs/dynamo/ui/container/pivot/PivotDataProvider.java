...
// */
//public class PivotDataProvider<T> implements DataProvider<T, SerializablePredicate<T>> {
//
//	private static final long serialVersionUID = 8057632998281455615L;
//
//	private DataProvider<T, SerializablePredicate<T>> sourceProvider;
//
...
//
//	public PivotDataProvider(DataProvider<T, SerializablePredicate<T>> sourceProvider, Object columnPropertyId,
//			Object rowPropertyId, List<?> columnIds, List<String> pivotedColumnPostFixes, int rowCount) {
...
//			for (Object i : sourceProvider.getContainerPropertyIds()) {
