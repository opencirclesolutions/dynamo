 ...
 */
public class QuickAddEntityComboBox<ID extends Serializable, T extends AbstractEntity<ID>> extends QuickAddEntityField<ID, T, T>
     ...
     */
    @SafeVarargs
    public QuickAddEntityComboBox(EntityModel<T> entityModel, AttributeModel attributeModel, BaseService<ID, T> service, SelectMode mode,
            SerializablePredicate<T> filter, boolean search, ListDataProvider<T> sharedProvider, List<T> items, SortOrder<?>... sortOrder) {
    ...
    public void setAdditionalFilter(SerializablePredicate<T> additionalFilter) {
        ...
        if (comboBox != null) {
            comboBox.refresh(getFilter() == null ? additionalFilter : new AndPredicate<T>(getFilter(), additionalFilter));
        }
    }
