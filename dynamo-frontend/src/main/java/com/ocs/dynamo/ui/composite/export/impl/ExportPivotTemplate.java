...
// * @author bas.rutten
// *
// * @param <ID> the class of the ID of the entity that is displayed in the row
// * @param <T> the class of the entity that is displayed in the row
// * @param <ID2> the class of the ID of the entity that is displayed in the
// *        column
// * @param <U> the class of the entity that is displayed in the row
// */
...
//		extends ModelBasedExcelExportTemplate<ID, T> {
//
//	/**
...
//	 * @param sortOrders      the sort orders used to order the search results
//	 * @param filter          the filter used to retrieve the search results
//	 * @param captions        the captions used for the fixed columns
//	 * @param title           the report title
//	 * @param customGenerator custom cell style generator
//	 * @param joins           the joins used when fetching search results
//	 */
...
////	 * 
////	 * @param iterator the data set iterator that contains the data to be exported
////	 * @return
////	 * @throws IOException
////	 */
////	@Override
...
//	 * 
//	 * @param iterator data set iterator for iterating over the rows
//	 * @return
//	 * @throws IOException
//	 */
//	@Override
...
//	 * 
//	 * @param u the entity that corresponds to the column
//	 * @return
//	 */
...
//
//	/**
//	 * Obtains the row ID from the entity - this is used to determine whether to
//	 * start on a new row
//	 * 
...
//	 * 
//	 * @param writer     the CVS writer
//	 * @param row        the current row
//	 * @param mode       the export mode
//	 * @param rowSum     the row sum
//	 * @param rowAverage the row average total
//	 * @param valueCount the number of written values
//	 */
//	private void writeCsvRow(CSVWriter writer, List<String> row, Integer rowSum, BigDecimal rowAverage,
//			int valueCount) {
//		if (!row.isEmpty()) {
//			if (createSumColumn()) {
...
//	 * @param lastColumnIndex the index of the last column
//	 * @param rowSum          the row sum
//	 * @param rowAverage      the row average
