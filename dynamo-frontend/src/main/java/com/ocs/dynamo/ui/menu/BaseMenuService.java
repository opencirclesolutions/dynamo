...
public abstract class BaseMenuService<T extends Component, U> {
     ...
     */
    private final Map<String, T> destinationMap = new HashMap<>();
     ...
     */
    protected void onSetVisible(Component component, boolean visible) {
    ...
    /**
     * Sets the visibility of a certain menu item based on its destiation
     *
     * @param destination the destination
     * @param mode        the screen mode
     * @param visible     the desired visibility
     */
    private void setVisible(String destination, String mode, boolean visible) {
        T menuItem = getDestination(destination, mode);
        if (menuItem != null) {
            menuItem.setVisible(visible);
            onSetVisible(menuItem, visible);
        }
    }

    /**
     * Sets the visibility of a certain item based on its destination (and
    ...
    public void setVisible(U root, String destination, String mode, boolean visible) {
        ...
        for (Component child : children) {
            setVisible(destination, mode, visible);
        }
