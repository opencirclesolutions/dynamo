...
//		if (exportAllowed) {
//			// addActionHandler(new TableExportActionHandler(UI.getCurrent(),
//			// getEntityModels(),
//			// rootEntityModel.getDisplayNamePlural(), null, true, TableExportMode.EXCEL,
//			// null));
//			// addActionHandler(new TableExportActionHandler(UI.getCurrent(),
//			// getEntityModels(),
//			// rootEntityModel.getDisplayNamePlural(), null, true,
//			// TableExportMode.EXCEL_SIMPLIFIED, null));
//			// addActionHandler(new TableExportActionHandler(UI.getCurrent(),
//			// getEntityModels(),
//			// rootEntityModel.getDisplayNamePlural(), null, true, TableExportMode.CSV,
//			// null));
//		}
//	}
//
