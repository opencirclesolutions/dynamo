...
//			EntityModel<?> entityModel, final AttributeModel attributeModel, final SerializablePredicate<S> filter,
...
//	public AbstractField<?> constructField(final AttributeModel attributeModel,
//			final Map<String, SerializablePredicate<T>> fieldFilters, final EntityModel<?> fieldEntityModel) {
...
//	}
//
//	public AbstractField<?> constructField(Context<?, T> context) {
//
...
//		if (field == null) {
//			Map<String, SerializablePredicate<T>> fieldFilters = context.getFieldFilters();
//			EntityModel<?> fieldEntityModel = context.getFieldEntityModel();
//
//			SerializablePredicate<T> fieldFilter = fieldFilters == null ? null
...
//					field = (AbstractField<?>) constructSimpleTokenField(
...
//		field.setRequiredIndicatorVisible(
...
//	 */
//	@SuppressWarnings("unchecked")
//	public <ID extends Serializable, S extends AbstractEntity<ID>> AbstractField<?> constructCollectionSelect(
//			final EntityModel<?> fieldEntityModel, final AttributeModel attributeModel,
//			final SerializablePredicate<S> fieldFilter, final boolean multipleSelect, final boolean search) {
...
//			final EntityModel<?> overruled, final AttributeModel attributeModel,
//			final SerializablePredicate<S> fieldFilter, final boolean search, final boolean multiSelect) {
//
...
//		final SortOrder[] sos = constructSortOrder(entityModel);
//		return new EntityLookupField<ID, S>(service, (EntityModel<S>) entityModel, attributeModel, fieldFilter, search,
...
//	 * @return
//	 */
//	public static ComboBox<String> constructStringListCombo(List<String> values, AttributeModel am) {
...
//		}
//
//		return new SimpleTokenFieldSelect<ID, S>(service, (EntityModel<S>) entityModel, attributeModel, fieldFilter,
...
//	 */
//	@SuppressWarnings({ "unchecked", "rawtypes" })
//	public <E extends AbstractField<?>> E createEnumCombo(final Class<?> type, final Class<E> fieldType) {
//		final AbstractSingleSelect s = createCompatibleSelect((Class<? extends AbstractSingleSelect>) fieldType);
...
//	public <F extends AbstractField> F createField(final Class<?> type, final Class<F> fieldType) {
//		if (Enum.class.isAssignableFrom(type)) {
//			if (AbstractSingleSelect.class.isAssignableFrom(fieldType)) {
//				return createEnumCombo(type, fieldType);
//			} else {
//				final ComboBox cb = createEnumCombo(type, ComboBox.class);
//				//cb.setFilteringMode(VaadinIcons.);
//				return (F) cb;
//			}
...
//	 */
//	@Override
//	public AbstractField<?> createField(final DataProvider<T, SerializablePredicate<T>> provider, final Object itemId,
...
//	 * @return
//	 */
//	public AbstractField<?> createField(final String propertyId) {
...
//	 * @return
//	 */
//	public AbstractField<?> createField(final String propertyId, final EntityModel<?> fieldEntityModel) {
//
...
//			final TextField tf = (TextField) createField(attributeModel.getType(), AbstractField.class);
...
//			field = createField(attributeModel.getType(), AbstractField.class);
//		}
//
...
//	 *            the attribute model
//	 */
//	private void postProcessField(final AbstractField<?> field, final AttributeModel attributeModel) {
...
//	 * @return
//	 */
//	protected AbstractField<?> constructSelectField(final AttributeModel attributeModel,
//			final EntityModel<?> fieldEntityModel, final SerializablePredicate<T> fieldFilter) {
//		AbstractField<?> field = null;
...
//	 */
//	@SuppressWarnings("unchecked")
//	private <E extends Enum<E>> void fillEnumField(final AbstractSingleSelect<?> select, final Class<E> enumClass) {
