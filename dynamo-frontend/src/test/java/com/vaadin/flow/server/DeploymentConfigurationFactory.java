...
//        return new DefaultDeploymentConfiguration(parentConfig, systemPropertyBaseClass,
...
//            ApplicationConfiguration parentConfig,
//            Class<?> systemPropertyBaseClass, VaadinConfig vaadinConfig) {
//        return new PropertyDeploymentConfiguration(parentConfig ,systemPropertyBaseClass,
//                createInitParameters(systemPropertyBaseClass, vaadinConfig));
//    }
//
//    /**
...
//            initParameters.setProperty(SERVLET_PARAMETER_COMPATIBILITY_MODE,
//                    String.valueOf(buildInfo
//                            .getBoolean(SERVLET_PARAMETER_COMPATIBILITY_MODE)));
