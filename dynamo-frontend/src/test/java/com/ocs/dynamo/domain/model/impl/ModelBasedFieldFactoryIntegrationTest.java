...
//		Assert.assertEquals(new SortOrder("name", SortDirection.ASCENDING), f.getSortOrders().get(0));
//
//	}
//
//	/**
...
//		Assert.assertEquals(new SortOrder("name", SortDirection.ASCENDING), f.getListSelect().getSortOrders()[0]);
