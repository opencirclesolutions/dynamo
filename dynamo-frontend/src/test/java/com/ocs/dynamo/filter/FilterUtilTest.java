...
//
//		Compare.Equal eq = new Compare.Equal("prop1", Boolean.TRUE);
//		Assert.assertTrue(FilterUtil.isTrue(eq, "prop1"));
//
//		eq = new Compare.Equal("prop1", Boolean.FALSE);
//		Assert.assertFalse(FilterUtil.isTrue(eq, "prop1"));
//
//		Compare.Equal eq2 = new Compare.Equal("prop1", "someString");
//		Assert.assertFalse(FilterUtil.isTrue(eq2, "prop1"));
//
//		// only works for Equal
//		Compare.Greater gt = new Compare.Greater("prop1", Boolean.TRUE);
...
//		com.vaadin.v7.data.Container.Filter f1 = FilterUtil.extractFilter(compare, "prop1", null);
//		Assert.assertNotNull(f1);
//
//		// wrong property
//		com.vaadin.v7.data.Container.Filter f2 = FilterUtil.extractFilter(compare, "prop2", null);
...
//
//		com.vaadin.v7.data.util.filter.Like like = new com.vaadin.data.util.filter.Like("prop1", "someString");
//		com.vaadin.v7.data.Container.Filter f1 = FilterUtil.extractFilter(like, "prop1", null);
//		Assert.assertNotNull(f1);
//
//		// wrong property
