...
//
//	private com.vaadin.v7.data.util.filter.Compare.Equal f1 = new com.vaadin.v7.data.util.filter.Compare.Equal("test",
//			"test");
//
//	private com.vaadin.v7.data.util.filter.Compare.Equal f2 = new com.vaadin.v7.data.util.filter.Compare.Equal("test",
//			"test");
//
//	@Override
//	public void setUp() {
...
//		Filter result = converter.convert(new com.vaadin.v7.data.util.filter.Compare.Equal("test", "test"));
//		Assert.assertTrue(result instanceof Compare.Equal);
//	}
//
//	@Test
//	public void testCompareLess() {
//		Filter result = converter.convert(new com.vaadin.v7.data.util.filter.Compare.Less("test", "test"));
//		Assert.assertTrue(result instanceof Compare.Less);
//	}
//
//	@Test
//	public void testCompareLessOrEqual() {
//		Filter result = converter.convert(new com.vaadin.v7.data.util.filter.Compare.LessOrEqual("test", "test"));
//		Assert.assertTrue(result instanceof Compare.LessOrEqual);
//	}
//
//	@Test
//	public void testCompareGreater() {
//		Filter result = converter.convert(new com.vaadin.v7.data.util.filter.Compare.Greater("test", "test"));
//		Assert.assertTrue(result instanceof Compare.Greater);
//	}
//
//	@Test
//	public void testCompareGreaterOrEqual() {
//		Filter result = converter.convert(new com.vaadin.v7.data.util.filter.Compare.GreaterOrEqual("test", "test"));
//		Assert.assertTrue(result instanceof Compare.GreaterOrEqual);
//	}
//
//	@Test
//	public void testNot() {
//		Filter result = converter.convert(new com.vaadin.v7.data.util.filter.Not(f1));
//		Assert.assertTrue(result instanceof Not);
//	}
//
//	@Test
//	public void testAnd() {
//		Filter result = converter.convert(new com.vaadin.v7.data.util.filter.And(f1, f2));
//		Assert.assertTrue(result instanceof And);
//	}
//
//	@Test
//	public void testOr() {
//		Filter result = converter.convert(new com.vaadin.v7.data.util.filter.Or(f1, f2));
//		Assert.assertTrue(result instanceof Or);
//	}
//
//	@Test
//	public void testBetween() {
//		Filter result = converter.convert(new com.vaadin.v7.data.util.filter.Between("test", 1, 10));
//		Assert.assertTrue(result instanceof Between);
//	}
//
//	@Test
//	public void testLike() {
//		Filter result = converter.convert(new com.vaadin.v7.data.util.filter.Like("test", "%test%"));
...
//				.convert(new com.vaadin.v7.data.util.filter.SimpleStringFilter("test", "test", false, true));
//		Assert.assertTrue(result instanceof Like);
...
//		Filter result = converter
//				.convert(new com.vaadin.v7.data.util.filter.SimpleStringFilter("test", "test", true, false));
//		Assert.assertTrue(result instanceof Like);
//		Like like = (Like) result;
...
//		Filter result = modelConverter.convert(new com.vaadin.v7.data.util.filter.And(
//				new com.vaadin.v7.data.util.filter.Compare.Equal("testEntities", new TestEntity2())));
//
//		Assert.assertTrue(result instanceof And);
...
//
//		Filter result = modelConverter.convert(new com.vaadin.v7.data.util.filter.And(
//				new com.vaadin.v7.data.util.filter.Compare.Equal("testEntities", entities)));
//
//		Assert.assertTrue(result instanceof And);
//		Filter first = ((And) result).getFilters().iterator().next();
