...
public class SortUtilTest {
    ...
    public void testTranslate() {
        ...
        com.ocs.dynamo.dao.SortOrder[] orders = SortUtil
                .translate(new com.vaadin.data.sort.SortOrder("test1", SortDirection.ASCENDING));
        ...
        orders = SortUtil.translate(new com.vaadin.data.sort.SortOrder("test2", SortDirection.DESCENDING));
        Assert.assertEquals(1, orders.length);
