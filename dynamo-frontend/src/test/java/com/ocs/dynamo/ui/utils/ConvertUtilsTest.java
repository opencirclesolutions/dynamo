...
public class ConvertUtilsTest {
	...
	public void testConvertToPresentationDates() {
		...
		// LocalDate
		Object s = ConvertUtils.convertToPresentationValue(model.getAttributeModel("birthDate"),
				LocalDate.of(2014, 1, 1));
		Assert.assertEquals("01-01-2014", ((LocalDate) s).format(DateTimeFormatter.ofPattern("dd-MM-yyyy")));

		// LocalDateTime
		s = ConvertUtils.convertToPresentationValue(model.getAttributeModel("registrationTime"),
