...
public class VaadinUtilsTest extends BaseMockitoTest {
	...
	public void testBigDecimalToString() {
		assertEquals("1.234,56%", VaadinUtils.bigDecimalToString(false, true, true,
				SystemPropertyUtils.getDefaultDecimalPrecision(), BigDecimal.valueOf(1234.56), LOCALE));
		assertEquals("1.234,56", VaadinUtils.bigDecimalToString(false, false, true,
				SystemPropertyUtils.getDefaultDecimalPrecision(), BigDecimal.valueOf(1234.56), LOCALE));
		assertEquals("1234,51", VaadinUtils.bigDecimalToString(false, false, false,
				SystemPropertyUtils.getDefaultDecimalPrecision(), BigDecimal.valueOf(1234.512), LOCALE));
		assertEquals("1234,512",
	...
	public void testStringToBigDecimal() {
		...
		assertEquals(1234.34, VaadinUtils.stringToBigDecimal(false, false, false, 2, "1234,34", LOCALE).doubleValue(),
				0.001);
		assertEquals(1234.3415,
		...
		assertEquals(1234, VaadinUtils.stringToBigDecimal(false, true, true, 2, "€ 1.234", LOCALE).doubleValue(),
				0.001);
	}
