...
//		SortOrder order = new SortOrder("id", SortDirection.ASCENDING);
...
//		EntityModel<TestEntity> em = factory.getModel(TestEntity.class);
//		AttributeModel am = em.getAttributeModel("testDomain");
//		com.vaadin.v7.data.sort.SortOrder order = new com.vaadin.v7.data.sort.SortOrder("id", SortDirection.ASCENDING);
