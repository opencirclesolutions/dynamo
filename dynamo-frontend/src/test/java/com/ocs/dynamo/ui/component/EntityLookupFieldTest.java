...
//				Lists.newArrayList(new com.vaadin.data.provider.SortOrder<String>("name", SortDirection.ASCENDING)));
//		MockUtil.injectUI(field, ui);
//
//		field.initContent();
//
//		Assert.assertEquals(new SortOrder<String>("name", SortDirection.ASCENDING), field.getSortOrders().get(0));
//
