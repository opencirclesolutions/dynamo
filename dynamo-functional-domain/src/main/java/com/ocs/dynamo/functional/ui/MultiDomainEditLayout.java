...
public class MultiDomainEditLayout extends BaseCustomComponent {
     ...
     */
    public MultiDomainEditLayout(FormOptions formOptions,
    ...
    public void build() {
        ...
        for (Class<? extends Domain> clazz : getDomainClasses()) {
            ...
            domainCombo.setItemCaption(clazz, getEntityModelFactory().getModel(clazz)
                    .getDisplayName());
        }
     ...
     */
    @SuppressWarnings("unchecked")
    private <T extends Domain> ServiceBasedSplitLayout<Integer, T> constructSplitLayout(
            Class<T> domainClass, FormOptions formOptions) {
