...
public class DomainDaoImpl extends DefaultDaoImpl<Integer, Domain> implements
		DomainDao {
	...
	public DomainDaoImpl(EntityPathBase<Domain> dslRoot,
	...
	public List<? extends Domain> findAllByType(Class<? extends Domain> type) {
		CriteriaQuery<? extends Domain> cq = getEntityManager()
				.getCriteriaBuilder().createQuery(type);
		cq.from(type);
