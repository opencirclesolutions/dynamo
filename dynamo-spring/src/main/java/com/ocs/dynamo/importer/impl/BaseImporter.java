    ...
    protected Object getFieldValue(PropertyDescriptor d, U unit, ImportField field) {
        ...
        if (String.class.equals(d.getPropertyType())) {
            ...
            if (value != null) {
                ...
                if (Integer.class.equals(d.getPropertyType()) || int.class.equals(d.getPropertyType())) {
                    obj = rounded.intValue();
                } else if (Long.class.equals(d.getPropertyType()) || long.class.equals(d.getPropertyType())) {
                    obj = rounded.longValue();
                } else if (Float.class.equals(d.getPropertyType()) || float.class.equals(d.getPropertyType())) {
