...
public class CollectionTable<T extends Serializable> extends CustomField<Collection<T>> implements
		SignalsParent {
	...
	protected Component initContent() {
		...
		table.setTableFieldFactory(new DefaultFieldFactory() {
			...
			public Field<?> createField(Container container, Object itemId, Object propertyId,
				...
				if (minLength != null) {
					f.addValidator(new StringLengthValidator(messageService
							.getMessage("ocs.value.too.short"), minLength, Integer.MAX_VALUE, true));
				}
