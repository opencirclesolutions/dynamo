...
/**
 * Utility class for registering Mockito mock objects in a Spring application context
 * 
 * @author bas.rutten
 */
public final class MockitoSpringUtil {
    ...
    /**
     * Registers all properties that are annotated with "@Mock" as beans in the string context
     * 
     * @param factory
     * @param subject
     * @param clazz
