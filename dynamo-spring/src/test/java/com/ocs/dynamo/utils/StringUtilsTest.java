...
public class StringUtilsTest {
	...
	public void testRestrictToMaxFieldLength() {
		...
		String result = StringUtil.restrictToMaxFieldLength("longlonglonglonglonglonglonglonglonglonglong",
		...
		result = StringUtil.restrictToMaxFieldLength("longlonglonglonglonglonglonglonglonglonglong", TestEntity.class,
				"somestring");
	...
	public void testIsValidEmail() {
		...
		Assert.assertFalse(StringUtil.isValidEmail(""));
		Assert.assertFalse(StringUtil.isValidEmail("@"));
		Assert.assertTrue(StringUtil.isValidEmail("a@b.com"));
		Assert.assertFalse(StringUtil.isValidEmail("a@b"));
