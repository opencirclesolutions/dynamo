...
public class TableUtilsTest extends BaseMockitoTest {
    ...
    public void testFormatPropertyValue() {
        ...
        // BigDecimal
        Assert.assertEquals("12,40", TableUtils.formatPropertyValue(null, factory, model, messageService, "discount",
                BigDecimal.valueOf(12.4), LOCALE));
        Assert.assertEquals("1.042,40", TableUtils.formatPropertyValue(null, factory, model, messageService, "discount",
        ...
        Assert.assertEquals("1,000.40", TableUtils.formatPropertyValue(null, factory, model, messageService, "discount",
                BigDecimal.valueOf(1000.4), Locale.US));

        // date
        Assert.assertEquals("12/10/2015", TableUtils.formatPropertyValue(null, factory, model, messageService,
                "birthDate", DateUtils.createDate("12102015"), LOCALE));

        // date (as week)
        Assert.assertEquals("2015-42", TableUtils.formatPropertyValue(null, factory, model, messageService, "birthWeek",
    ...
    class Entity4 extends AbstractEntity<Integer> {
        ...
        private static final long serialVersionUID = -2017448969926824049L;
