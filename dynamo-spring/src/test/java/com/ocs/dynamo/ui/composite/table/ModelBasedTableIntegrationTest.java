...
public class ModelBasedTableIntegrationTest extends BaseIntegrationTest {
    ...
    public void testIdBasedQuery() {
        ServiceContainer<Integer, TestEntity> container = new ServiceContainer<>(testEntityService, false, 20,
                QueryType.ID_BASED, new FetchJoinInformation[0]);
    ...
    public void testWrapperIdBasedQuery() {
        ...
        ServiceResultsTableWrapper<Integer, TestEntity> wrapper = new ServiceResultsTableWrapper<>(testEntityService,
                model, QueryType.ID_BASED, null, null, false, null);
        wrapper.build();
    ...
    public void testWrapperIdBasedQuery_SortOrder() {
        ...
        ServiceResultsTableWrapper<Integer, TestEntity> wrapper = new ServiceResultsTableWrapper<Integer, TestEntity>(
                ...
                Lists.newArrayList(new SortOrder("name", SortDirection.ASCENDING)), false, null);
        wrapper.build();
    ...
    /**
     * Test the working of a model based table combined with a service container using a paging
     * query
     */
    @Test
    public void testPagingQuery() {
        ServiceContainer<Integer, TestEntity> container = new ServiceContainer<>(testEntityService, false, 20,
                QueryType.PAGING, null);
        Assert.assertNotNull(container.getService());
    ...
    public void testSort() {
        ServiceContainer<Integer, TestEntity> container = new ServiceContainer<>(testEntityService, entityModelFactory,
