...
/**
 * A table component for displaying data based on the entity model.
 *
 * Operates on an entity model (that governs which columns to display and how to display them)
 * and a search object (that specifies the various search criteria)
 */
@Component({
