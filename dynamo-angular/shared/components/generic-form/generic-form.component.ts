...
import { AdditionalActionMode } from '../../model/additional-action-mode';
...
import { AutoFillDialogComponent } from '../auto-fill-dialog/auto-fill-dialog.component';
...
@Component({
  ...
  providers: [BindingService, HiddenFieldService]
})
