...
public final class VaadinUtils {
    ...
    /**
     * Returns the locale to be used inside date picker components. This checks for the presence of
     * the DynamoConstants.DATE_LOCALE setting on the session. If this is not set, it falls back to
     * the normal locale mechanism
     * 
     * @return
     */
    ...
    /**
     * Reads the desired locale for formatting date fields from the system properties and stores it
     * in the session
     */
    ...
    /**
     * Stores the default locale configured in the system properties in the Vaadin session
     */
